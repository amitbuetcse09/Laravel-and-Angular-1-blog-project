...
<head>
	<meta charset="UTF-8">
	<title>Laravel and Angular Comment</title>
...
<div class="col-md-6 col-md-offset-3">
	...
	<div class="comment" ng-hide="loading" ng-repeat="comment in comments">
		<span><h3>Comment #{{ comment.id }} </h3> by </span><p style="background-color:blue;border-radius:5%;color:white;padding:10px;">
		 {{ comment.author }}
		 </p><p style="color:gray;"><i>{{ comment.created_at }} </i></p>
		<p>{{ comment.text }}</p>

		<p><a href="#" ng-click="deleteComment(comment.id)" class="btn btn-info text-muted">Delete</a></p>
	</div>
